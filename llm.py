...
DEFAULT_MLX_MODEL = "mlx-community/Mistral-Small-24B-Instruct-2501-4bit"
...
class LLM:
    def __init__(self, api_key: str = None, base_url: str = None, model: str = None, lang: str = "English"):
        if api_key:
            ...
            self.mlx_model, self.mlx_tokenizer = load(mlx_model_name, tokenizer_config={"fix_mistral_regex": True})
            self.llm = None
        self.model = model
        self.lang = lang
